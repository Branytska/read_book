<?php
    include "db.inc.php";
    $query = "SELECT a.id_plant, a.kind, a.taxonomic, b.name, a.area_foto, a.strength, a.relevance, a.kind_foto FROM plants a, status_kind b WHERE a.id_status_kind = b.id_status_kind";
    ...
    if($result){
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo '<a href=".plant'.$row['id_plant'].'" class="open_popup" data-effect="mfp-zoom-out"> <i class="hovicon effect-9 sub-b"></i></a>';
            echo '</div>';
            echo '<div class="mfp-hide mfp-with-anim work_desc plant'.$row['id_plant'].'">';
